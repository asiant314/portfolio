...
function drawSkills() {
  ...
  var margin = {top: 100, right: 100, bottom: 100, left: 100},
    width = .8*viewportWidth - margin.left - margin.right,
  ...
  d3.csv("skillData.csv", type, function(error, data) {
    ...
    visBody.append("div")
      ...
      .enter().append("a")
        ...
        .style("left", function(d) { return x(d.x) + margin.left - circleRadius + "px"; })
        .style("top", function(d) { return y(d.y) + margin.top - circleRadius*.4 + "px"; })
        .style("text-anchor", "middle")
